...
# 웹 구상 (페이지 구현 후 이미지 등록 + 간단한 소개)

### 메인 페이지

- 페이지 구현 후 이미지 등록 + 간단한 소개
...
| 9    |                   | 상품 상세 정보 페이지 출력                        | 미구현(랜덤으로 대체)             |
| 10   |                   | 예/적금 관심상품 등록 기능                        | ⭐⭐⭐⭐⭐                             |
| 12   | 환율 계산기       | API를 활용한 환율 정보 출력                       | ⭐⭐⭐⭐(비영업일 데이터를 받지 못함) |
| 13   |                   | 환율 계산기 기능 구현                             | ⭐⭐⭐⭐                              |
...
| 21   |                   | 비밀번호 변경 및 회원 탈퇴                        | ⭐⭐⭐⭐⭐                             |
| 22   |                   | 작성 게시글/댓글 바로가기                         | 미구현                            |
| 23   |                   | 개인별 상품 추천 알고리즘                         | 미구현                            |
